...
const AdminPanel: React.FC<Props> = ({ user, onLogout }) => {
  const isSuperAdmin = user.roleType === 'SUPER_ADMIN'; // Kiểm tra quyền super admin
  const isEditor = user.roleType === 'EDITOR'; // Kiểm tra quyền editor (Mentor, Trưởng Ban, Phó Ban)
  ...
  return (
    <div className="space-y-6 relative pb-10">
      ...
      {/* Continue with the rest of your panel logic */}
    </div>
  );
};
